...
@section('content')
<form action="{{ route('outgoingMail.update', $outgoingMail->id) }}" method="POST" class="bg-white p-4 rounded-2 border" enctype="multipart/form-data">
    @csrf
    <div class="row">
        <div class="col-md-12 col-sm-6">
            ...
            <div class="form-floating mb-3">
                <input type="text" name="no_mail" id="no_mail" value="{{ $outgoingMail->no_mail }}" class="form-control" placeholder="">
                @error('no_mail')
        ...
        <div class="col-md-12 col-sm-6">
            ...
            <div class="form-floating mb-3">
                <input type="date" name="date" class="form-control" value="{{ $outgoingMail->date }}" id="date" placeholder="">
                @error('date')
                <span class="text-danger">{{$message}}</span>
                @enderror
        ...
        <div class="col-md-12 col-sm-6">
            ...
            <div class="form-floating mb-3">
                <input type="text" name="as_for" id="as_for" class="form-control" value="{{ $outgoingMail->as_for }}" placeholder="">
                @error('as_for')
                <span class="text-danger">{{$message}}</span>
                @enderror
        ...
        <div class="col-md-12 col-sm-6">
            ...
            <div class="form-floating mb-3">
                <input type="text" name="to" id="to" class="form-control" value="{{ $outgoingMail->to }}" placeholder="">
                @error('to')
                <span class="text-danger">{{$message}}</span>
                @enderror
        ...
        <div class="col-md-12 col-sm-6">
            ...
            <div class="form-floating mb-3">
                <select name="characteristic" id="characteristic" class="form-select">
                    <option value="rahasia" {{ $outgoingMail->characteristic == 'rahasia' ? 'selected' :''}}>Rahasia</option>
                    <option value="penting" {{ $outgoingMail->characteristic == 'penting' ? 'selected' :''}}>Penting</option>
                    <option value="segera" {{ $outgoingMail->characteristic == 'segera' ? 'selected' :''}}>Segera</option>
                    <option value="biasa" {{ $outgoingMail->characteristic == 'biasa' ? 'selected' :''}}>Biasa</option>
                </select>
        ...
        <div class="col-md-12 col-sm-6">
            ...
            <div class="form-floating mb-3">
                <input type="text" name="address" id="address" class="form-control" value="{{ $outgoingMail->address }}" placeholder="">
                @error('address')
                <span class="text-danger">{{$message}}</span>
                @enderror
        ...
        <div class="col-md-12 col-sm-6">
            ...
            <div class="form-floating mb-3">
                <textarea class="form-control" name="content" cols="10" id="content"  placeholder="">{{ $outgoingMail->content }}</textarea>
                @error('content')
                <span class="text-danger">{{$message}}</span>
                @enderror
