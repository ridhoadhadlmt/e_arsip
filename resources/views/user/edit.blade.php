...
<form action="{{ route('user.update', $user->id) }}" method="POST" class="bg-white p-4 rounded-2 border">
    @csrf
    <div class="row">
        <div class="col-md-12 col-sm-6">
            ...
            <div class="form-floating mb-3">
                <input type="text" value="{{ $user->name }}" id="name" name="name" class="form-control" placeholder="">
        ...
        <div class="col-md-12 col-sm-6">
            ...
            <div class="form-floating mb-3">
                <input type="text" value="{{ $user->username }}" id="username" name="username" class="form-control" placeholder="">
        ...
        <div class="col-md-12 col-sm-6">
            ...
            <div class="form-floating mb-3">
                <input type="email" value="{{ $user->email }}" id="email" name="email" class="form-control" placeholder="">
        ...
        <div class="col-md-12 col-sm-6">
            ...
            <div class="form-floating mb-3">
                <input type="password" value="{{ $user->password }}" name="password" id="password" class="form-control" placeholder="">
